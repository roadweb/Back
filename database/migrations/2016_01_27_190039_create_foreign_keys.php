...
class CreateForeignKeys extends Migration {
	...
	public function up()
	{
		...
		Schema::table('user_socialnetwork', function(Blueprint $table) {
			$table->foreign('userdetails_id')->references('id')->on('userdetails')
						->onDelete('no action')
						->onUpdate('no action');
		});
		Schema::table('user_socialnetwork', function(Blueprint $table) {
	...
	public function down()
	{
		...
		Schema::table('user_socialnetwork', function(Blueprint $table) {
			$table->dropForeign('user_socialnetwork_userdetails_id_foreign');
		});
		Schema::table('user_socialnetwork', function(Blueprint $table) {
		...
		Schema::table('posts', function(Blueprint $table) {
			$table->dropForeign('posts_userdetails_id_foreign');
		});
		Schema::table('asks', function(Blueprint $table) {
