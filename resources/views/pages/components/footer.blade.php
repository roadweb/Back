    ...
    <div class="rw-index-footer-container">
        ...
        <div class="rw-index-footer-nav">
            <div class="rw-index-footer-nav-networks">
                ...
                <ul>
                    <li class="rw-hidden">
                        <a href=""><img src="{{ asset('images/reseaux-icon/linkedin.png')}}" alt="linkedin"/></a>
                    </li>
                    <li>
                        <a href=""><img src="{{ asset('images/reseaux-icon/twitter.png')}}" alt="twitter"/></a>
                    </li>
                    <li>
                        <a href=""><img src="{{ asset('images/reseaux-icon/facebook.png')}}" alt="facebook"/></a>
                    </li>
                    <li class="rw-hidden">
                        <a href=""><img src="{{ asset('images/reseaux-icon/pinterest.png')}}" alt="pinterest"/></a>
                   </li>
                    <li class="rw-hidden">
                        <a href=""><img src="{{ asset('images/reseaux-icon/google-plus.png')}}" alt="google +"/></a>
                    </li>
                    <li class="rw-hidden">
                        <a href=""><img src="{{ asset('images/reseaux-icon/behance.png')}}" alt="behance"/></a>
                    </li>
                </ul>
            </div>
