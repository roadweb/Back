            ...
            <div class="rw-jobs-index-container-flex">
        		<div class="rw-jobs-index rw-job-color-1">
                    ...
                    <div class="rw-jobs-index-description">
                        ...
                        <button class="rw-jobs-click-view rw-job-color-txt-1"><i class="fa fa-angle-down"></i></button>

    	    		</div>

    	    		<div class="rw-jobs-index-triangle rw-job-color-triangle-1"></div>
        		</div>
        		<div class="rw-jobs-index rw-job-color-2">
    	    		<div class="rw-jobs-index-icon">
    	    			<img src="{{ asset('images/webdesign.png') }} "/>
    	    		</div>
                    <div class="rw-jobs-index-description">
                        <h1 class="rw-job-color-txt-2">Webdesigner</h1>
                        <p>Issu du métier de graphiste, le webdesigner conçoit le site web du point de vue visuel mais aussi ergonomique...
                        </p>
                        <div class="rw-jobs-index-fiche rw-jobs-hide">
                            <p>
                        ...
                        <button class="rw-jobs-click-view rw-job-color-txt-2"><i class="fa fa-angle-down"></i></button>

    	    		</div>

    	    		<div class="rw-jobs-index-triangle rw-job-color-triangle-2"></div>
        		</div>

                <div class="rw-jobs-index rw-job-color-3">
                    <div class="rw-jobs-index-icon">
                        <img src="{{ asset('images/webmarketing.png') }} "/>
                    </div>
                    <div class="rw-jobs-index-description">
                        <h1 class="rw-job-color-txt-3">Webmarketing</h1>
                        <p>Issu du métier de graphiste, le webdesigner conçoit le site web du point de vue visuel mais aussi ergonomique...
                        </p>
                        <div class="rw-jobs-index-fiche rw-jobs-hide">
                            <p>
                        ...
                        <button class="rw-jobs-click-view rw-job-color-txt-3"><i class="fa fa-angle-down"></i></button>

                    </div>

                    <div class="rw-jobs-index-triangle rw-job-color-triangle-3"></div>
                </div>
                <div class="rw-jobs-index rw-job-color-4">
                    <div class="rw-jobs-index-icon">
                        <img src="{{ asset('images/cm.png') }} "/>
                    </div>
                    <div class="rw-jobs-index-description">
                        <h1 class="rw-job-color-txt-4">Community Management</h1>
                        <p>Issu du métier de graphiste, le webdesigner conçoit le site web du point de vue visuel mais aussi ergonomique...
                        </p>
                        <div class="rw-jobs-index-fiche rw-jobs-hide">
                            <p>
                        ...
                        <button class="rw-jobs-click-view rw-job-color-txt-4"><i class="fa fa-angle-down"></i></button>

                    </div>

                    <div class="rw-jobs-index-triangle rw-job-color-triangle-4"></div>
                </div>

                <div class="rw-jobs-index rw-job-color-5">
                    <div class="rw-jobs-index-icon">
                        <img src="{{ asset('images/integration.png') }} "/>
                    </div>
                    <div class="rw-jobs-index-description">
                        <h1 class="rw-job-color-txt-5">Intégration</h1>
                        <p>Issu du métier de graphiste, le webdesigner conçoit le site web du point de vue visuel mais aussi ergonomique...
                        </p>
                        <div class="rw-jobs-index-fiche rw-jobs-hide">
                            <p>
                        ...
                        <button class="rw-jobs-click-view rw-job-color-txt-5"><i class="fa fa-angle-down"></i></button>

                    </div>

                    <div class="rw-jobs-index-triangle rw-job-color-triangle-5"></div>
                </div>
                <div class="rw-jobs-index rw-job-color-6">
                    <div class="rw-jobs-index-icon">
                        <img src="{{ asset('images/referencement.png') }} "/>
                    </div>
                    <div class="rw-jobs-index-description">
                        <h1 class="rw-job-color-txt-6">Référencement</h1>
                        <p>Issu du métier de graphiste, le webdesigner conçoit le site web du point de vue visuel mais aussi ergonomique...
                        </p>
                        <div class="rw-jobs-index-fiche rw-jobs-hide">
                            <p>
                        ...
                        <button class="rw-jobs-click-view rw-job-color-txt-6"><i class="fa fa-angle-down"></i></button>

                    </div>

                    <div class="rw-jobs-index-triangle rw-job-color-triangle-6"></div>
                </div>
